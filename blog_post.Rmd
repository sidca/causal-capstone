...
This plot tells us that as the vaccination rate increases in our group, the effectiveness of getting a vaccine decreases. For example, when 20% of your group is vaccinated, the vaccine decreases the probability of catching cholera by 15%. But if 80% of your group is vaccinated, the decrease is only ~10%.(how can I communicate that this is literally percent_getting_cholera - 10% and not percent_getting_cholera*.90?) This makes intuitive sense, as when more people are vaccinated, they are less likely to spread the virus to you, meaning a vaccine has less risk to protect from. 
